...
class usf:
    def __init__(
        ...
        self.model = None # will be defined when using self.sample()
    ...
    def sample(self, x, model_fn, decisions, steps=20, t_start=None, t_end=None, order=2, skip_type='time_uniform', prediction_type="noise_prediction", 
        ...
        with torch.no_grad():
            ...
            if afs == "no_afs":
                ...
                raise NotImplementedError("don't support average x0 for latent diffusion model")
