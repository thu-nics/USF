...
def parse_args_and_config(parameters=None):
    ...
    # for dpm-solver-v3
    parser.add_argument("--use_dpm_solver_v3", action="store_true", help="Use DPM Solver v3 if set.")
    ...
    parser.add_argument("--dpmsolver_v3_t_start", type=float, default=80, help="Start time for DPM Solver v3 EMS.")
    parser.add_argument("--dpmsolver_v3_t_end", type=float, default=0.002, help="End time for DPM Solver v3 EMS.")
...
def main():
    ...
    os.makedirs('temp', exist_ok=True) # store temporary files, like skip coefficients
    try:
