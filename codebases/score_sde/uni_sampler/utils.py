...
def get_empirical_decisions(args, sampler, device):
    '''
    Func: get all searchable decisions to match common sampler configurations. Decisions include: 1. taylor expansion orders; 2. timesteps; 3. prediction types; 4. derivative types; 5. start points; 6. corrector types; 7. use AFS(no_afs,zero_x0,average_x0);8. skip coefficients.
    '''
